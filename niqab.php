...
<head>
  <meta charset="utf-8">
  <title>Niqab Collection | Scarf4u</title>
  <link rel="stylesheet" href="css/style.css" />
  <link href="css/niqab.css" rel="stylesheet"/>
...
<body>
  ...
  <article class="niqab">
    ...
    <div class="all_image">
      ...
      <?php
          $query = "SELECT * FROM products WHERE category = 'Niqab' ORDER BY product_id ASC";
          ...
          if(mysqli_num_rows($result) > 0) {
              ...
              while ($row = mysqli_fetch_array($result)) {
                  ...
                  ?>
                  <form method="post" action="niqab.php?action=add&id=<?php echo $row["product_id"]; ?>">
                    <div>
