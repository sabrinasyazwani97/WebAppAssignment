<?php include 'add-shawl-tocart.php';?>

<html>
	<head lang = "en">
		<meta charset = "utf-8">
		<title>Shawl Colection | Scarf4u</title>
		<link rel="stylesheet" href="style.css" />
		<link href="shawl.css" rel="stylesheet"/>
	...
	<body>
		...
		<article class="shawl">
			...
			<?php
			  $query = "SELECT * FROM products WHERE category = 'Shawl' ORDER BY id ASC";
			  ...
			  if(mysqli_num_rows($result) > 0) {
				  ...
				  while ($row = mysqli_fetch_array($result)) {
					  ...
					  ?>
					  <form method="post" action="shawl.php?action=add&id=<?php echo $row["id"]; ?>">
						<div>
